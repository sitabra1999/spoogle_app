            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  style: const TextStyle(color: AppColor.violet, fontSize: 16),
                  decoration: InputDecoration(
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: AppColor.violet.withOpacity(1)),
                    ),
                    hintText: 'Enter the event name',
                    hintStyle:
                        TextStyle(color: AppColor.violet.withOpacity(0.6), fontSize: 16),
                  ),
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              foregroundDecoration: BoxDecoration(
                                ...
                                color: AppColor.eventColors[index],
                              ),
                              width: 32,
                              height: 32,
                            ),
  ...
  void _onEventCreation() {
    ...
    Navigator.of(context).pop(
      CalendarEventModel(
        ...
        eventColor: AppColor.eventColors[_selectedColorIndex],
      ),
    );
  }
      ...
      properties: DatePickerProperties(
        ...
        yearPickerItemBuilder: (year, isPicked) => Container(
          ...
          decoration: BoxDecoration(
            color: isPicked ? AppColor.violet : Colors.white,
            borderRadius: const BorderRadius.all(Radius.circular(8)),
          ),
          child: Center(
            child: Text(year.toString(),
                style: TextStyle(
                    color: isPicked ? Colors.white : AppColor.violet, fontSize: 16)),
          ),
        ),
