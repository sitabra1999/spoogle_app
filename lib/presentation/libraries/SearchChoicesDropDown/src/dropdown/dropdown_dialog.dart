...
import 'package:flutter_spoogle_app/presentation/libraries/SearchChoicesDropDown/search_choices.dart';
        ...
        ? Container(
            ...
            child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: <Widget>[
                      doneButtonWidget ?? const SizedBox.shrink(),
      ...
      child: Stack(
        children: <Widget>[
          TextField(
            ...
            decoration: widget.searchInputDecoration ?? (widget.rightToLeft
