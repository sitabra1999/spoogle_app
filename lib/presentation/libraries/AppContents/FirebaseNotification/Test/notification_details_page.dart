...
class NotificationDetailsPage extends StatefulWidget {
  ...
  const NotificationDetailsPage({Key? key, required this.receivedNotification}) : super(key: key);
...
class _NotificationDetailsPageState extends State<NotificationDetailsPage> {
  ...
  void initState() {
    ...
    displayedDate = AwesomeDateUtils.parseDateToString(
        AwesomeDateUtils.utcToLocal(AwesomeDateUtils.parseStringToDate(widget.receivedNotification.displayedDate)!),
                      ...
                      (widget.receivedNotification.title?.isEmpty ?? true)
                          ...
                          : (widget.receivedNotification.body?.isEmpty ?? true)
                              ...
                              : Container(
                                  ...
                                  child: Text(widget.receivedNotification.bodyWithoutHtml ?? '',
                                      style: themeData.textTheme.bodyText2)),
                    ],
                  ),
                ),
                Container(
                  constraints: BoxConstraints(minWidth: mediaQueryData.size.width,),
                  child: Column(
                    children: <Widget>[
                      Container(
                          width: mediaQueryData.size.width,
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text('ReceivedNotification details:',
                                style: themeData.textTheme.subtitle1?.copyWith(color: themeData.hintColor),
                              ),
                              const SizedBox(height: 20),
                              Text(
                                widget.receivedNotification.toString(),
                                style: themeData.textTheme.bodyText2?.copyWith(color: themeData.hintColor),
                              ),
                            ],
                          )),
                    ],
