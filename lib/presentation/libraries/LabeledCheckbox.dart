...
class _LabeledCheckboxState extends State<LabeledCheckbox> {
  ...
  Widget _buildCheckbox(BuildContext context) {
    return SizedBox(
      ...
      width: 20,
      child: Checkbox(
        fillColor: value? MaterialStateProperty.all(Colors.black54) : MaterialStateProperty.all(Colors.black38),
  ...
  Widget _buildLabel(BuildContext context) {
    var padding = widget.leadingCheckbox ? const EdgeInsets.only(right: 6) : const EdgeInsets.only(left: 6);
