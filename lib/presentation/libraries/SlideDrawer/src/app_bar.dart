...
import 'package:flutter_spoogle_app/presentation/libraries/SlideDrawer/src/helper/slider_app_bar.dart';
...
class SAppBar extends StatelessWidget {
  ...
  List<Widget> appBar() {
    List<Widget> list = [
      ...
      Expanded(
        child: sliderAppBar.isTitleCenter ? Center(child: sliderAppBar.title) : sliderAppBar.title,
      ),
      sliderAppBar.trailing ?? const SizedBox(width: 35)
    ];
