...
import 'package:flutter_spoogle_app/presentation/libraries/SlideDrawer/src/slider_direction.dart';
...
class SliderDrawerState extends State<SliderDrawer> with TickerProviderStateMixin {
  ...
  /// Toggle drawer
  void toggle() =>
      _animationDrawerController!.isCompleted ? _animationDrawerController!.reverse() : _animationDrawerController!.forward();
...
class _Shadow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, child) {
        return Transform.translate(
          offset: Utils.getOffsetValueForShadow(slideDirection, animation.value, sliderOpenSize),
          child: child,
        );
      },
      child: Container(
